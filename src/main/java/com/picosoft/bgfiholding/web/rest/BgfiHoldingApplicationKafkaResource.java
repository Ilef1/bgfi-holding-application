...
@RestController
@RequestMapping("/api/bgfi-holding-application-kafka")
public class BgfiHoldingApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BgfiHoldingApplicationKafkaResource.class);
    ...
    public BgfiHoldingApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
